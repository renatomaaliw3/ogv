	...
	<div id="outerbox">
			...
			<div id="branding2">
				...
				<ol id="year">
					...
					<li class="folder"><a target='_blank' href='printoutgrade_student.php?studentid=<?php echo $_SESSION['studentid']; ?>'> RATING HISTORY </a></li>
					<li class="folder"><a target='_blank' href='printout_evaluation_student.php?studentid=<?php echo $_SESSION['studentid']; ?>'> RATING EVALUATION </a></li>
